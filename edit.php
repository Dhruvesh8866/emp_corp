...
$result = mysqli_query($conn, "UPDATE `employee` SET `firstName`='$firstname',`lastName`='$lastname',`email`='$email',`birthday`='$birthday',`gender`='$gender',`contact`='$contact',`nid`='$nid',`address`='$address',`dept`='$dept',`skills`='$skill',`degree`='$degree' WHERE id=$id");
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="edit.php" method="POST">
                        ...
                        <div class="input-group">
                        <lable>Skills</lable>
                            <input class="input--style-1" type="text" name="skill" value="<?php echo $skill;?>">
                        </div>
