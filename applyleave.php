...
<html>
<head>
	<title>Apply Leave | Employee Panel | EMP Corporation</title>
	...
	<table>
			...
			<?php
				...
				while ($employee = mysqli_fetch_assoc($result)) {
					...
					echo '<td><form method="POST" action="cancelleave.php">
					<input type="text" style="display:none" value=" '.$id.' " name="emp_id">
					<Button type="submit" value="Cancel" style="margin-left:10px;height:30px;width=150px;background-color: #57b846;color: white">Cancel</button>
					</form></td>';
				}
