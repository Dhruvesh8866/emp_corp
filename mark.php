...
$sql = "SELECT pid, project.eid, pname, duedate, subdate, submitedfile, mark, points, firstName, lastName, base, bonus, total FROM `project` , `rank` ,`employee`, `salary`  WHERE project.eid = $id AND pid = $pid";
...
<html>
<head>
  <title>Project Mark | EMP Corporation</title>
  <!-- Icons font CSS-->
            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "registration" action="mark.php" method="POST">
                        ...
                        <a href="<?php echo "process/".$submitedfile ?>" download>submitted file </a>
                        <div class="p-t-20">
